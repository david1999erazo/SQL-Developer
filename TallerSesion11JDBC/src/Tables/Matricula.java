...
public class Matricula {
	...
	public void create_table() throws Exception {
		PreparedStatement stmt = con.prepareStatement(
				...
				"CREATE TABLE Matricula (" + "estudiante VARCHAR2(50 CHAR) NOT NULL," + "curso NUMBER NOT NULL,"
						+ "PRIMARY KEY (estudiante, curso)," + "FOREIGN KEY (estudiante) REFERENCES Estudiante,"
